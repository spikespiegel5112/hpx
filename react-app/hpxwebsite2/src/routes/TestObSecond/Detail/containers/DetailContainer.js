...
const mapStateToProps = (state) => ({
    ...
    secondProps:{
        err: state.testObGoodsModule.err,
        saveStatus: state.testObGoodsModule.saveStatus,
        list : state.testObGoodsModule.list,
        listStatus : state.testObGoodsModule.listStatus,
        deleteStatus : state.testObGoodsModule.deleteStatus,
    }
})
