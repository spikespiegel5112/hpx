...
class Compo extends React.Component{
    constructor(props){
        ...
        this.state={
            ...
            tradeData : [],
            voucherData : [],
            product: 'FRCTOR_CUSTMOER',//产品默认为海供应惠
    ...
    fetch(key,timeDimension){
        return async()=>{
            ...
            if(this.state.product=='FRCTOR_CUSTMOER'){
                this.setState({
                    factorData :  res
                })
            }else if(this.state.product=='TRADE_CUSTMOER'){
                this.setState({
                    tradeData :  res
                })
            }else{
    ...
    render(){
        ...
        return (          
            ...
            <Tabs defaultActiveKey="FRCTOR_CUSTMOER" onChange={(key)=>this.changeTabs(key)}>
                <TabPane tab="海供惠" key="FRCTOR_CUSTMOER">
                    <div>
                        ...
                        <div style={{width: "84%",float:"left"}}>
                            ...
                            />
                           <Button type="danger" style={{marginLeft:25,width:60}} onClick={(key)=>this.changeTimeDimension("YEAR")}>年</Button>
                ...
                <TabPane tab="海销惠" key="TRADE_CUSTMOER">
                    <div style={{width: "16%",float:"left"}}>
                ...
                <TabPane tab="海票汇" key="VOUCHER__CUSTMOER">
                    <div style={{width: "16%",float:"left"}}>
