...
class Compo extends React.Component{
    constructor(props){
        ...
        this.state={
            ...
            tradeData : [],
            voucherData : [],
            product: 'FRCTOR_TRANSACTIONFLOW',//产品默认为海供应惠
    ...
    fetch(key,timeDimension){
        return async()=>{
            ...
            if(this.state.product=='FRCTOR_TRANSACTIONFLOW'){
                this.setState({
                    factorData :  res
                })
    ...
    render(){
        ...
        return (          
            ...
            <Tabs defaultActiveKey="FRCTOR_TRANSACTIONFLOW" onChange={(key)=>this.changeTabs(key)}>
                <TabPane tab="海供惠" key="FRCTOR_TRANSACTIONFLOW">
                    <div>
