...
class Compo extends React.Component {
  constructor(props) {
    ...
    this.columns = [{
      ...
      },
      {
        ...
        render: (text, record) => 
          <span>{
            [{"value":"0","name":"停用"},{"value":"1","name":"启用"}]
        ...
        render: (text, record) => (
          <span>
            ...
            <Link to={`${this.getUrlQueryParams()}/redact/${record.id}`}>
              编辑
            </Link>
            <span className="ant-divider" />
             {record.gradeCardState == '1'?
  ...
  search() {
    ...
    let arr = [{
        ...
        key: 'field2',
        value: {
          value: queryParams.field2 && queryParams.field2.value
            ? queryParams.field2.value.length > 0
              ? [
                this.getMomentFormat(queryParams.field2.value[0]),
                this.getMomentFormat(queryParams.field2.value[1]),
              ].filter((v) => !!v)
              : null
            : null,
        }
        ...
        key: 'field3',
        value: {
          value: queryParams.field3 ? queryParams.field3.value : null
       } 
      },{
        key: 'field4',
        value: {
        ...
        key: 'field5',
        value: {
          value: queryParams.field5 ? queryParams.field5.value : null
        }
      }];
    let obj = {};
  ...
  getUrlQueryParams(v) {
    ...
    return '/hpx2/warningModel/' + encodeURI(JSON.stringify(v || {}));
  }
  ...
  render() {
    ...
    let view = <div>
      <div style={{ marginBottom: 16 }}>
        ...
        />
        <Link 
          to={`${this.getUrlQueryParams()}/add/0`} 
