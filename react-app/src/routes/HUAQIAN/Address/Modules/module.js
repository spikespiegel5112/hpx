  ...
  return async (dispatch, getState) => {
    ...
    try{
      const resp = await getReq(
        '/proxyHq'+'/huaqian/api/v1/address/search',
        queryParams
      )
...
export  const fetchDetail =  (id) => {
  return async (dispatch, getState) => {
    ...
    try{
      const resp = await getReq(
        '/proxyHq'+'/huaqian/api/v1/address/get/'+id,
        {
        }
      )
      const result = await resp.json();
  ...
  return async (dispatch, getState) => {
    ...
    try{
      const resp = await deleteReq(
        '/proxyHq'+'/huaqian/api/v1/address/delete/'+id,
        {
        }
      )
      // const result = await resp.json();
  ...
  return async (dispatch, getState) => {
    ...
    try{
      const resp = 
        id 
        ? await patchReq(
            '/proxyHq'+'/huaqian/api/v1/address/update/'+id,
            {
                ...values,
            }
          )
        : await putReq(
            '/proxyHq'+'/huaqian/api/v1/address/add',
            {
                ...values,
                id: id || '',
            }
