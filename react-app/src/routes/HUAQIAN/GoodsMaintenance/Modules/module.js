...
export const fetchList =  () => {
  return async (dispatch, getState) => {
    ...
    let description = queryParams.description ? queryParams.description.value : null;
    if(description) queryParams.description = queryParams.description.value;
    else delete queryParams.description;
