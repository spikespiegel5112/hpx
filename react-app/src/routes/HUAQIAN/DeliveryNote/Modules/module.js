  ...
  return async (dispatch, getState) => {
    ...
    try{
      const resp = await getReq(
        '/proxyHq'+'/huaqian/api/v1/deliveryNote/search',
        queryParams
      )
...
export  const fetchDetail =  (id) => {
  return async (dispatch, getState) => {
    ...
    try{
      const resp = await getReq(
        '/proxyHq'+'/huaqian/api/v1/deliveryNote/get/'+id,
        {
        }
      )
      const result = await resp.json();
  ...
  return async (dispatch, getState) => {
    ...
    try{
      const resp = await deleteReq(
        '/proxyHq'+'/huaqian/api/v1/deliveryNote/delete/'+id,
        {
        }
      )
      dispatch({
  ...
  return async (dispatch, getState) => {
    ...
    try{
      const resp = 
        id 
        ? await patchReq(
            '/proxyHq'+'/huaqian/api/v1/deliveryNote/update/'+id,
            {
                ...values,
            }
          )
        : await putReq(
            '/proxyHq'+'/huaqian/api/v1/deliveryNote/add',
            {
                ...values,
                id: id || '',
            }
