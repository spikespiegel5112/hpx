  ...
  return async (dispatch, getState) => {
    ...
    try{
      const resp = await getReq(
        '/proxyHq'+'/huaqian/api/v1/deliveryNote/getDetail',
        queryParams
      )
  ...
  return async (dispatch, getState) => {
    ...
    try{
      const resp = await deleteReq(
        '/proxyHq'+'/huaqian/api/v1/deliveryNote/deleteDetail/'+id,
        {
        }
      )
      dispatch({
  ...
  return async (dispatch, getState) => {
    ...
    try{
      const resp = 
        id 
        ? await patchReq(
            '/proxyHq'+'/huaqian/api/v1/deliveryNote/updateDetail/'+id,
            {
                ...values,
            }
          )
        : await putReq(
            '/proxyHq'+'/huaqian/api/v1/deliveryNote/addDetail',
            {
                ...values,
                id: id || '',
            }
