...
class AddCardForm extends React.Component {
  ...
  getUrlQueryParams(v) {
    ...
    return '/hpx2/core/project/' + encodeURI(JSON.stringify(v || {}));
  }
      ...
      <Form onSubmit={this.handleSubmit}>
        ...
        >
          {getFieldDecorator('projectType',{
            rules: [
              { required: true, message: '请评分标准类型'},
            ],
          })(
            <Select placeholder="请评分标准类型" >
        ...
        >
          {getFieldDecorator('role',{
            rules: [
              { required: true, message: '请评分标准角色'},
            ],
          })(
            <Select placeholder="请评分标准角色" >
        ...
        >
          {getFieldDecorator('projectModel',{
            rules: [
              { required: true, message: '请评分标准模式'},
            ],
          })(
            <Select placeholder="请评分标准模式" >
