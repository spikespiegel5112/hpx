  ...
  render() {
    ...
    return (
      <Form onSubmit={this.handleSubmit}>
        ...
        <FormItem
          key="productEnterpriseRoles"
          {...formItemLayout}
          label="产品类型"
        >
          {getFieldDecorator('productEnterpriseRoles', {
            rules: [
            ...
            >
              {this.props.productEnterpriseRolesAll.map(temp => <Option key={temp.code}>{temp.name}</Option>)}
            </Select>
            )}
