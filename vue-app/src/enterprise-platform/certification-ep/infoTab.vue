                        ...
                        <el-col :span="12">
                            <el-form-item label="是否三证合一" prop="iscode31">
                                <el-select v-show="!isEdite.base" v-model="baseInfoForm.iscode31">
                                    <el-option v-for="item in isCode31Options" :value="item.value" :key="item.value" :label="item.label">
                                    </el-option>
                                </el-select>
                    ...
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="工商注册时间" prop="regDate">
                                <el-date-picker v-show="!isEdite.business" v-model="regDate" type="date" @change="regDateChange" placeholder="选择日期">
                                </el-date-picker>
                        ...
                        <el-col :span="12">
                            <el-form-item label="工商注册币种" prop="regCurrency">
                                <el-select v-show="!isEdite.business" v-model="businessInfoForm.regCurrency">
                                    <el-option v-for="item in regCurrencyOptions" :value="item.value" :key="item.value" :label="item.label">
                                    </el-option>
                                </el-select>
                        ...
                        <el-col :span="12">
                            <el-form-item label="公司年检时间" prop="inspectionTime">
                                <el-date-picker v-show="!isEdite.business" v-model="inspectionTime" type="date" @change="inspectionTimeChange" placeholder="选择日期">
                                </el-date-picker>
                    ...
                    <el-row>
                        ...
                        <el-col :span="12">
                            <el-form-item label="授权人邮箱" prop="contactsEmail">
                                ...
                                <div class='cer-text-div' v-show="isEdite.contacts">{{contactsInfoForm.contactsEmail}}</div>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                    ...
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="纳税类型" prop="taxType">
                                ...
                                <div class='cer-text-div' v-show="isEdite.taxRegistration">{{taxRegistrationInfoForm.taxType}}</div>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="税号" prop="taxNumber">
                                <el-input v-show="!isEdite.taxRegistration" v-model="taxRegistrationInfoForm.taxNumber" placeholder="请输入税号"></el-input>
                                <div class='cer-text-div' v-show="isEdite.taxRegistration">{{taxRegistrationInfoForm.taxNumber}}</div>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-form>
                        ...
                        try {
                            ...
                            switch (type) {
                                case 'base':
                                    ...
                                    break;
                                case 'business':
                                    params = this.businessInfoForm;
                                    break;
                                case 'contacts':
                                    params = this.contactsInfoForm;
                                    break;
                                case 'taxRegistration':
                                    params = this.taxRegistrationInfoForm;
                                    break;
                                default:
                                    params = {};
                            }
