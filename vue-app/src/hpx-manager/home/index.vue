    ...
    <div>
		...
		<section class="data_section">
			...
			<el-row :gutter="20" style="margin-bottom: 10px;">
				...
				<el-col :span="4"><div class="data_list"><span class="data_num">{{orderCount}}</span> 新增项目</div></el-col>
            ...
            <el-row :gutter="20">
                ...
                <el-col :span="4"><div class="data_list"><span class="data_num">{{allOrderCount}}</span> 项目</div></el-col>
